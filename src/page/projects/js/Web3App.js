        ...
        <Box w={['375px', null, '650px', '750px', '1000px', '1250px']}>
            ...
            <Stack mt='16px'>
                ...
                <Text>
                    ...
                    The purpose of this project is to create a community web application for one or multiple projects in cryptocurrency, 
            ...
            <Stack>
                <Text mt='16px'>
                    ...
                    In the frontend, I have a function called within my Redux implementation that retrieves the data from these JSON files. 
